...
`product-service` comienza en `0.1.0`, correspondiente a su desarrollo inicial. La versión del
...
- Los tags deben identificar el servicio, por ejemplo `product-service-v0.1.0`.
